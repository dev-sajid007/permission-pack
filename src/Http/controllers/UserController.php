...
use DevSajid\Permission\Models\User;
use DevSajid\Permission\Traits\FileSaver;
...
class UserController extends Controller
{
    ...
    public function create(){
        ...
        $roles = Role::all();
        return view('permission::user.create',compact('roles'));
    }
    ...
    public function edit($id){
        ...
        $user = User::find($id);
        $roles = Role::all();
        return view('permission::user.create',compact('user','roles'));
    }
