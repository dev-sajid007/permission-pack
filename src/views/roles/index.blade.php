            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('app.roles.create') }}" class="btn btn-primary float-right"><i class="fa fa-plus"></i> Add New</a>
                    </div>
                    <div class="card-body">
                        <table id="dataTable" class="table custom-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($role->permissions)
                                            <div class="badge badge-success">{{count($role->permissions)}}</div>
                                        @else
